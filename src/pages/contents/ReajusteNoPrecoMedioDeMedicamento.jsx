...
export default () => (
    <div>
        ...
        <h2 className="materia-title">Governo adquire repelentes para gestantes de baixa renda</h2>
        <p className="simple-text">Mulheres grávidas inscritas no programa Bolsa Família podem receber de maneira gratuita repelentes para se proteger contra o Aedes aegypti, transmissor da dengue, zika e chikungunya. O benefício está disponível desde 2017, quando Governo do Brasil investiu R$ 82 milhões na aquisição do produto, visando beneficiar 500 mil mulheres.</p>
